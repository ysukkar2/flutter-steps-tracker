...
import 'package:footsteps/di/injection_container.dart';
import 'package:footsteps/features/intro/presentation/manager/auth_status/auth_status_cubit.dart';
import 'package:footsteps/generated/l10n.dart';
import 'package:footsteps/utilities/locale/cubit/utility_cubit.dart';
import 'package:footsteps/utilities/locale/cubit/utility_state.dart';
import 'package:footsteps/utilities/locale/theme_data.dart';
import 'package:footsteps/utilities/routes/router.dart';
...
Future<void> _initialize() async {
  ...
  await Firebase.initializeApp(
    options:const FirebaseOptions(
      ...
      apiKey: 
'AIzaSyDKR4gnOizddZhBgdfGHy-lGecatztuSFE',

       appId: '1:230840314713:android:5306209a90675408957a48',
        messagingSenderId:'230840314713',
         projectId: 'steps-flutter'
         )
  );
  await configure();
}
